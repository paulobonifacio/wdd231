// Export the function to initialize the home page (uncomment export if used in a module)
document.addEventListener("DOMContentLoaded", () => {
        const spotlightsMainBox = document.querySelector(".spotlights-main-box");
        spotlightsMainBox.innerHTML = "";

        // Function to create a spotlight card
        ...
        // Generate and append three spotlight cards
        for (let i = 1; i <= 3; i++) {
            spotlightsMainBox.appendChild(createSpotCard(i));
        }
    });
    
    // Fetch and populate spotlight data
    ...
    const myKey = "4571614e7734dc12e19dc02211ceb2fd";
    const myLat = "46.948002";
    const myLon = "7.448130";
